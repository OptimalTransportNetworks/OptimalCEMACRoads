...
\noindent at a cost of 2.5 billion USD'15. Ostensibly, these planned projects include both high and low yield links and are mainly aimed at connecting major cities of Douala, Bangui and N'Djamena. %Only the link from Bangui to Bossembele is part of the consensus package with links above 1\$/min/\$. The links from Mbaiki to Bangui and from Bossembele to Yaloke are also part of the package with links above  0.5\$/min/\$. The main reason is that, except for links near Bangui, many of these roads connect smaller towns in rather unpopulated regions. 
